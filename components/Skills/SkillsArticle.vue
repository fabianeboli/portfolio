...
<template>
  <div class="flex flex-col-reverse sm:flex-row justify-center items-center gap-x-60 mx-10 sm:mx-[12.5%] relative top-20 sm:top-10 sm:mt-[10%]">
    <div class="flex-1 mx-52">
      <Skills />
    </div>
